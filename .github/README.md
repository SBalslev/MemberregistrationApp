...
1. **Copy `.github/copilot/ai-seed.md`** to your repo's `.github/` directory
...
4. **Configure** `.github/copilot/project-config.md` to enable/disable features
...
│                    Copilot Reads...                         │
├─────────────────────────────────────────────────────────────┤
│  1. .github/copilot-instructions.md (main entry point)      │
│     ↓                                                       │
│  2. .github/copilot/project-config.md (check toggles)       │
│     ↓                                                       │
...
│     ↓                                                       │
│  5. .github/instructions/*.md matched by file type          │
│     ↓                                                       │
...
Edit `.github/copilot/project-config.md` to enable/disable:
...
1. Copy `.github/copilot/ai-seed.md` to the target repo's `.github/` directory
